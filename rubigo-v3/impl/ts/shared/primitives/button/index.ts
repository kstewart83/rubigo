 ...
 * Import from './bindings/solid' or './web-component' for framework-specific bindings.
 */

// Re-export SolidJS bindings as default
export { Button, useButton, type UseButtonOptions, type UseButtonReturn } from './bindings/solid';
