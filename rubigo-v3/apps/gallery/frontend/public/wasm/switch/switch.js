...
export class Switch {
    ...
    get state_name() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.switch_state_name(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
     ...
     */
    set_focused() {
        const ret = wasm.switch_set_focused(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
    ...
    get context_json() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.switch_context_json(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     */
    clear_focused() {
        const ret = wasm.switch_clear_focused(this.__wbg_ptr);
        return ret !== 0;
    }
    constructor() {
        const ret = wasm.switch_new();
     ...
     */
    toggle() {
        const ret = wasm.switch_toggle(this.__wbg_ptr);
        return ret !== 0;
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('switch_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
