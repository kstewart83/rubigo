...
export class Input {
    ...
    get state_name() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.input_state_name(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
     ...
     */
    set_focused() {
        const ret = wasm.input_set_focused(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
    ...
    get context_json() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.input_context_json(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     */
    clear_focused() {
        const ret = wasm.input_clear_focused(this.__wbg_ptr);
        return ret !== 0;
    }
    constructor() {
     ...
     */
    set_value() {
        const ret = wasm.input_set_value(this.__wbg_ptr);
        return ret !== 0;
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('input_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
