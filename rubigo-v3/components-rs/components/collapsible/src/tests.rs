...
fn dispatch_event(comp: &mut Collapsible, event: &str) {
    match event {
            "EXPAND" => { let _ = comp.expand(); }
            "COLLAPSE" => { let _ = comp.collapse(); }
