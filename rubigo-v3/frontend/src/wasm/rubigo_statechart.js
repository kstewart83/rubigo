...
export class WasmMachine {
     ...
     */
    getContext() {
        const ret = wasm.wasmmachine_getContext(this.__wbg_ptr);
        if (ret[2]) {
    ...
    currentState() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.wasmmachine_currentState(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
    ...
    getContextJson() {
        ...
        let deferred2_1;
        try {
            const ret = wasm.wasmmachine_getContextJson(this.__wbg_ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
     ...
     * @param {boolean} value
     */
    setContextBool(key, value) {
        const ptr0 = passStringToWasm0(key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.wasmmachine_setContextBool(this.__wbg_ptr, ptr0, len0, value);
    }
    /**
     ...
     * @returns {any}
     */
    sendWithPayload(event_name, payload_js) {
        const ptr0 = passStringToWasm0(event_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmmachine_sendWithPayload(this.__wbg_ptr, ptr0, len0, payload_js);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @param {number} value
     */
    setContextNumber(key, value) {
        const ptr0 = passStringToWasm0(key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.wasmmachine_setContextNumber(this.__wbg_ptr, ptr0, len0, value);
    }
    /**
     ...
     * @param {string} value
     */
    setContextString(key, value) {
        const ptr0 = passStringToWasm0(key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(value, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        wasm.wasmmachine_setContextString(this.__wbg_ptr, ptr0, len0, ptr1, len1);
    }
    /**
    ...
    send(event_name) {
        const ptr0 = passStringToWasm0(event_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmmachine_send(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    constructor(json_config) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmmachine_from_json(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('rubigo_statechart_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
