...
export const wasmmachine_getContextJson: (a: number) => [number, number, number, number];
export const wasmmachine_send: (a: number, b: number, c: number) => [number, number, number];
export const wasmmachine_sendWithPayload: (a: number, b: number, c: number, d: any) => [number, number, number];
