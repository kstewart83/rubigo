 ...
 * - Persona switcher and sign out in More drawer
 */
...
// =====================================================================
export function MobileNav({ personnel }: MobileNavProps) {
    ...
    const [showPersonaSwitcher, setShowPersonaSwitcher] = React.useState(false)
    ...
    return (
        <>
            ...
            <PersonaSwitcher
                ...
                onOpenChange={setShowPersonaSwitcher}
            />
        </>
    )
}
