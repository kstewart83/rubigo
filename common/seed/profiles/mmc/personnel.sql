...
-- tenant_clearances: JSON array like ["moderate:🍎", "low:🍌"]
...
INSERT INTO personnel (profile_id, id, name, email, title, department, site, building, level, space, manager, photo, desk_phone, cell_phone, bio, clearance_level, tenant_clearances, access_roles) VALUES 
...
('mmc', 'eng008', 'Kevin Zhang', 'kzhang@mmc.com', 'R&D Engineer', 'Engineering', 'MMC Headquarters', 'HQ Main Building', 2, '203', 'David Park', NULL, '614-555-4103', NULL, 'Kevin leads prototyping efforts for next-gen product lines.', 'moderate', '["moderate:🍇", "moderate:🍓"]', '["employee"]'),
...
('mmc', 'mfg010', 'Umar Khan', 'ukhan@mmc.com', 'Maintenance Tech', 'Manufacturing', 'MMC Headquarters', 'Manufacturing Plant', 1, 'MP-108', 'Jennifer Walsh', NULL, '614-555-8106', NULL, 'Umar performs preventative maintenance on plant equipment.', 'moderate', '["moderate:🍇"]', '["employee"]'),
...
('mmc', 'mfg012', 'Wendy Li', 'wli@mmc.com', 'Production Planner', 'Manufacturing', 'MMC Headquarters', 'Manufacturing Plant', 1, 'MP-109', 'Jennifer Walsh', NULL, '614-555-8108', NULL, 'Wendy schedules production runs based on demand.', 'moderate', '["moderate:🍇"]', '["employee"]'),
...
('mmc', 'sales08', 'Eleanor Rigby', 'erigby@mmc.com', 'Account Manager', 'Sales', 'MMC Headquarters', 'HQ Main Building', 1, '103', 'Chris Miller', NULL, '614-555-6102', NULL, 'Eleanor handles national key accounts and contracts.', 'low', '["low:🍌"]', '["employee"]'),
('mmc', 'sales09', 'Frank Castle', 'fcastle@mmc.com', 'Sales Engineer', 'Sales', 'MMC Headquarters', 'HQ Main Building', 1, '103', 'Chris Miller', NULL, '614-555-6103', NULL, 'Frank provides technical support during the sales process.', 'low', '["low:🍌", "low:🍇"]', '["employee"]'),
...
('mmc', 'ops009', 'Oliver Queen', 'oqueen@mmc.com', 'Fleet Manager', 'Operations', 'MMC Headquarters', 'Distribution Center', 1, 'DC-105', 'Brian Mitchell', NULL, '614-555-7106', NULL, 'Oliver manages the company truck fleet and maintenance.', 'low', '["low:🍌"]', '["employee"]');

-- IT EXPANSION (+4)
INSERT INTO personnel (profile_id, id, name, email, title, department, site, building, level, space, manager, photo, desk_phone, cell_phone, bio, clearance_level, tenant_clearances, access_roles) VALUES 
('mmc', 'it007', 'David Kim', 'dkim@mmc.com', 'Security Analyst', 'IT', 'MMC Headquarters', 'HQ Main Building', 1, '102', 'Sarah Kim', NULL, '614-555-2101', NULL, 'David monitors SIEM logs for security anomalies.', 'moderate', '["moderate:🍎"]', '["employee", "security"]'),
...
('mmc', 'it009', 'Frank Wright', 'fwright@mmc.com', 'Network Engineer', 'IT', 'MMC Headquarters', 'HQ Main Building', 1, '102', 'Sarah Kim', NULL, '614-555-2103', NULL, 'Frank supports network upgrades and cabling.', 'moderate', '["moderate:🍎"]', '["employee"]'),
('mmc', 'it010', 'Grace Lee', 'glee@mmc.com', 'Database Administrator', 'IT', 'MMC Headquarters', 'HQ Main Building', 1, '102', 'Mike Chen', NULL, '614-555-2104', NULL, 'Grace manages SQL Server and PostgreSQL instances.', 'high', '["high:🍎"]', '["employee"]');
...
('mmc', 'cs007', 'Kate Bishop', 'kbishop@mmc.com', 'CS Team Lead', 'Customer Service', 'MMC Headquarters', 'HQ Main Building', 1, '105', 'Rachel Green', NULL, '614-555-9104', NULL, 'Kate trains new hires and handles escalations.', 'low', '["low:🍌"]', '["manager"]'),
...
('mmc', 'cs010', 'Nick Fury', 'nfury@mmc.com', 'Customer Success Mgr', 'Customer Service', 'MMC Headquarters', 'HQ Main Building', 1, '105', 'Rachel Green', NULL, '614-555-9107', NULL, 'Nick ensures long-term satisfaction for enterprise accounts.', 'low', '["low:🍌"]', '["manager"]');
...
('mmc', 'hr004', 'Isaac Vance', 'ivance2@mmc.com', 'Recruiter', 'HR', 'MMC Headquarters', 'HQ Main Building', 1, '101', 'Patricia Martinez', NULL, '614-555-3102', NULL, 'Isaac manages the hiring pipeline for technical roles.', 'moderate', '["moderate:🍎"]', '["employee"]'),
('mmc', 'hr005', 'Julia Patel', 'jpatel@mmc.com', 'Benefits Coordinator', 'HR', 'MMC Headquarters', 'HQ Main Building', 1, '101', 'Patricia Martinez', NULL, '614-555-3103', NULL, 'Julia administers health insurance and 401k programs.', 'moderate', '["moderate:🍎", "low:🍌"]', '["employee"]'),
...
('mmc', 'fin004', 'Yvonne Cole', 'ycole@mmc.com', 'Payroll Specialist', 'Finance', 'MMC Headquarters', 'HQ Main Building', 3, '301', 'Emily Rodriguez', NULL, '614-555-5102', NULL, 'Yvonne processes bi-weekly payroll for all employees.', 'moderate', '["moderate:🍊"]', '["employee"]'),
...
INSERT INTO personnel (profile_id, id, name, email, title, department, site, building, level, space, manager, photo, desk_phone, cell_phone, bio, is_agent, clearance_level, tenant_clearances, access_roles) VALUES ('mmc', 'agent01', 'ARIA', 'aria@mmc.com', 'AI Research Assistant', 'IT', 'MMC Headquarters', 'HQ Main Building', 1, '102-AI', 'Mike Chen', NULL, NULL, NULL, 'ARIA (Artificial Research & Intelligence Agent) assists with data analysis, research synthesis, and technical documentation. Designed to support engineering and IT teams with information retrieval and analysis tasks.', 1, 'low', '["low:🍎"]', '["employee"]');
